...
```bash
# Run analysis
node .claude/skills/platform-prototype-skill/scripts/analyze-layout.js references

# Verify output
./.claude/skills/platform-prototype-skill/scripts/verify-layout-analysis.sh references

# Test and view insights
node .claude/skills/platform-prototype-skill/scripts/test-analyze-layout.js references
```
...
```bash
# Run capture first
node .claude/skills/platform-prototype-skill/scripts/full-site-capture.js
```
