...
node /path/to/.claude/skills/platform-prototype-skill/scripts/validate-accessibility.js .
```
...
../.claude/skills/platform-prototype-skill/scripts/integrate-accessibility.sh
```
